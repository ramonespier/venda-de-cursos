...
$cursos = [
    'gastronomia' => [
        ...
        'aprendera' => 'Aqui você aprenderá: Higiene e boas práticas.<br>
        Preparo, técnicas de cozinhar para cortar e temperar, refogar, assar, grelhar.<br>
        Gastronomia: servindo pratos deliciosos e repletos de arte.<br>
        Confeitaria: a arte e técnica unida ao açúcar.<br>
        Apresentação de pratos: entregando um trabalho de excelência.',
    ...
    'dev' => [
        ...
        'aprendera' =>  'Você aprenderá:<br>
                        Iniciando o desenvolvimento de páginas Web a partir do HTML e CSS.<br>
                        Criando interatividade com JavaScript.<br>
                        Aprimorando as funções do site utilizando frameworks: react, node.js, tailwindcss.<br>
    ...
    'python' => [
        ...
        'aprendera' =>  'Aprendendo a linguagem Python. <br>
        Fundamentos: variáveis, estrutura de controle, funções e estrutura de Dados. <br>
        Estrutura de dados: listas, tuplas, dicionários, conjuntos <br>
        Desenvolvendo a linguagem: orientação a objetos, manipulação de arquivos, bibliotecas padrão, bibliotecas populares. <br>
    ...
    'designgrafico' => [
        ...
        'aprendera' =>  'Você aprenderá: <br>
                Fundamentos: Introdução, princípios básicos, teoria e psicologia das cores. Além de tipografia.<br>
                Ferramentas: Canva e Adobe em suas diferentes versões: Photoshop, Illustrator, InDesign.<br>
                Design para Web: Design responsivo e layout par sites, UX, UI e design de banners.<br>
                Identidade visual e Branding: logotipos, marcas e elementos gráficos.<br>
                Mídias Sociais: Conteúdo para Instagram, Facebook e outras plataformas<br>
    ...
    'marketing' => [
        ...
        'descricao' => 'O marketing digital é a chave para o sucesso e a sobrevivência das marcas no mundo de hoje. O FocusHub oferece um curso online completo, com estratégias de SEO, tráfego pago e influenciadores, ensinando táticas que podem transformar sua marca, engajar seu público e gerar resultados reais. O futuro do marketing já chegou, e você pode ser parte dessa revolução agora!',

        'aprendera' =>  'Você aprenderá: <br>
                Fundamentos: introdução, diferenças entre o tradicional e digital, KPI´S.<br>
                Otimização para motores de busca: overview e aprofundamento (estrutura, carregamento, análise e acompanhamento de resultados). <br>
                Focando no mercado digital: desenvolvendo estratégias em diferentes formatos, sejam fotos, arquivos(e-books) ou vídeos. <br>
                Gerenciando tráfego pago: Google ADS, Facebook ADS, Publicidade no Instagram, Publicidade no Youtube. <br>
                Marketing Science: Análise de Dados, métricas, taxa de conversão, ROI, CAC.',

        'imagem' => 'marketing.jpg',

        'video' => '<iframe title="vimeo-player" class="w-full h-full" src="https://player.vimeo.com/video/1034744569?h=cf559344a7" frameborder="0" allowfullscreen></iframe>',
